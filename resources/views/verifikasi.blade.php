...
<meta charset="utf-8" />
        ...
        <link href="{{asset ('boot/css/verifikasi.css')}}" rel="stylesheet" />
</head>
<body>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 text-black">
        <div class="text-center">
          <h2 class="text-judul">Verivikasi OTP</h2>
          <p class="text-1">Masukan kode OTP yang telah kami kirimkan ke alamat email anda</p>
        </div>
