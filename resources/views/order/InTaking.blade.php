...
<body>
    <div class="container">
        <h1>Pesanaan {{ $data->order_id }} Dalam Pengambilan</h1>
        <div class="order-info">
            ...
            <p><strong>Pesanaan Mulai Diambil:</strong> {{ $data->updated_at }}</p>
            <p><strong>BATAS WAKTU PENGAMBILAN:</strong> {{ $data->expiration_date }}</p>
        </div>
