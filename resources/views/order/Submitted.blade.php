...
<body>
    <div class="container">
        <h1>Pesanaan {{ $data->order_id }} Telah Diserahkan</h1>
        <div class="order-info">
            ...
            <p><strong>Pesanaan Dikonfirmasi:</strong> {{ $data->confirmation_date }}</p>
            <p><strong>Pesanaan Diserahkan:</strong> {{ $data->updated_at }}</p>
            <p><strong>BATAS WAKTU SELESAIKAN PESANAN:</strong> {{ $data->expiration_finished }}</p>
        </div>
        ...
        <div class="i-do">
            ...
            <p>TODO : Kasih langkah-langkah tata cara pembayaran</p>
        </div>
    </div>
</body>
