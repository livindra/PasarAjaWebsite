...
<body>
    <div class="container">
        <h1>Pesanaan {{ $data->order_id }} Telah DiKonfirmasi</h1>
        <div class="order-info">
            ...
            <p><strong>Pesanaan DiKonfirmasi:</strong> {{ $data->updated_at }}</p>
            <p><strong>BATAS PEMGAMBILAN BARANG:</strong> {{ $data->expiration_date }}</p>
        </div>
